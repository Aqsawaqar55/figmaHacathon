  ...
  return (
    <>
      ...
      <div className="relative w-full h-screen flex items-center justify-center bg-cover bg-center">
        ...
        {/* Hero Text */}
        <div className="relative bg-[#FFF3E3] mt-[120px] px-6 w-[643px] h-[443px] md:p-12 lg:p-16 rounded-lg shadow-lg max-w-[90%] md:max-w-[50%] text-center md:text-left ml-auto mr-[5%]">
